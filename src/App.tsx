...
const ROW1_IMAGES = [
  "https://eunocanva.shop/wp-content/uploads/2026/05/argentina4.png",
  "https://eunocanva.shop/wp-content/uploads/2026/05/argentina.png",
  "https://eunocanva.shop/wp-content/uploads/2026/05/carro7.png",
  "https://eunocanva.shop/wp-content/uploads/2026/05/carro8.png",
  "https://eunocanva.shop/wp-content/uploads/2026/05/carro10.png",
  "https://eunocanva.shop/wp-content/uploads/2026/05/argentina2.png",
  "https://eunocanva.shop/wp-content/uploads/2026/05/carro1.png"
];

const ROW2_IMAGES = [
  "https://eunocanva.shop/wp-content/uploads/2026/05/carro11.png",
  "https://eunocanva.shop/wp-content/uploads/2026/05/brasil2.png",
  "https://eunocanva.shop/wp-content/uploads/2026/05/brasil1.png",
  "https://eunocanva.shop/wp-content/uploads/2026/05/brasil10.png",
  "https://eunocanva.shop/wp-content/uploads/2026/05/brasil7.png",
  "https://eunocanva.shop/wp-content/uploads/2026/05/brasil5.png",
  "https://eunocanva.shop/wp-content/uploads/2026/05/colombia3.png"
];
      ...
      <section className="relative pt-12 pb-20 sm:pb-24 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-yellow-500/10 via-[#080808] to-[#080808] border-b border-white/5 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
            ...
            {/* Centered Sales Pitch Content */}
            <div className="w-full flex flex-col items-center">
              {/* Tagline / Badges */}
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-yellow-400/10 border border-yellow-400/20 rounded-full leading-none mb-6">
              ...
              {/* Heading */}
              <h2 className="font-display font-black text-4xl sm:text-5xl lg:text-6xl tracking-tight text-white leading-[0.95] italic uppercase text-center">
              ...
              <p className="mt-6 text-slate-300 text-sm sm:text-base lg:text-lg font-light leading-relaxed max-w-2xl">
              ...
              <div className="mt-8 p-5 bg-white/5 border border-white/10 rounded-2xl shadow-xl flex flex-col sm:flex-row items-center gap-5 backdrop-blur-sm w-full max-w-2xl">
              ...
              <div className="mt-4 flex flex-wrap items-center justify-center gap-4 text-slate-400 text-xs font-medium">
          ...
          <div className="mt-20 relative border-t border-white/5 pt-12">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-sm sm:text-base text-yellow-500 font-black tracking-widest uppercase animate-pulse">RESTAM APENAS {slotsLeft} VAGAS</p>
            </div>

            {/* Two-row infinite scrolling Marquee Carousel */}
            <div className="flex flex-col gap-4 sm:gap-6 select-none overflow-hidden my-8 relative">
              
              {/* Row 1: Going to Right */}
              <div className="relative w-full overflow-hidden py-1.5">
                <div className="animate-marquee-right flex gap-2.5 sm:gap-4">
                  {/* Tripled to guarantee absolutely continuous infinite loops across all screens */}
                  {[...ROW1_IMAGES, ...ROW1_IMAGES, ...ROW1_IMAGES].map((url, index) => (
                    <motion.div 
                      key={`gallery-r1-${index}`} 
                      whileHover={{ y: -6, scale: 1.04 }}
                      className="w-[100px] h-[140px] min-with-380:w-[115px] min-with-380:h-[162px] min-[380px]:w-[115px] min-[380px]:h-[162px] sm:w-[150px] sm:h-[210px] md:w-[160px] md:h-[220px] flex-shrink-0 rounded-xl sm:rounded-2xl overflow-hidden border border-white/10 bg-[#121212] shadow-2xl hover:border-yellow-500/80 hover:shadow-[0_0_20px_rgba(234,179,8,0.25)] transition-all duration-300 relative group flex items-center justify-center p-0.5 sm:p-1 cursor-pointer"
                    >
                      {/* Shiny holographic overlay */}
                      <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none z-20" />
                      
                      <div className="w-full h-full bg-gradient-to-b from-[#1b1b1b] to-[#0a0a0a] rounded-lg sm:rounded-xl overflow-hidden relative flex items-center justify-center">
                        <img 
                          src={url} 
                          alt="Card Seleção Premium" 
                          className="w-full h-full object-contain filter drop-shadow-[0_4px_6px_rgba(0,0,0,0.6)]" 
                          referrerPolicy="no-referrer" 
                        />
                        
                        {/* High Resolution Watermark Badge */}
                        <div className="absolute bottom-1 bg-black/80 px-1 py-0.5 text-[7px] sm:text-[8px] rounded font-mono border border-white/5 text-slate-300 z-10 scale-90 sm:scale-100">
                          300 DPI
                        </div>
                      </div>
                    </motion.div>
              ...
              {/* Row 2: Going to Left */}
              <div className="relative w-full overflow-hidden py-1.5">
                <div className="animate-marquee-left flex gap-2.5 sm:gap-4">
                  {/* Tripled to guarantee absolutely continuous infinite loops across all screens */}
                  {[...ROW2_IMAGES, ...ROW2_IMAGES, ...ROW2_IMAGES].map((url, index) => (
                    <motion.div 
                      key={`gallery-r2-${index}`} 
                      whileHover={{ y: -6, scale: 1.04 }}
                      className="w-[100px] h-[140px] min-[380px]:w-[115px] min-[380px]:h-[162px] sm:w-[150px] sm:h-[210px] md:w-[160px] md:h-[220px] flex-shrink-0 rounded-xl sm:rounded-2xl overflow-hidden border border-white/10 bg-[#121212] shadow-2xl hover:border-yellow-500/80 hover:shadow-[0_0_20px_rgba(234,179,8,0.25)] transition-all duration-300 relative group flex items-center justify-center p-0.5 sm:p-1 cursor-pointer"
                    >
                      {/* Shiny holographic overlay */}
                      <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none z-20" />
